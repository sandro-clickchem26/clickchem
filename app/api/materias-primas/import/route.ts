...
Retorne APENAS este JSON (sem texto fora do JSON):
{
  ...
  "categoria": "categoria principal: Solventes | Tensoativos Aniônicos | Tensoativos Não-iônicos | Tensoativos Catiônicos | Tensoativos Anfóteros | Espessantes | Sequestrantes | Neutralizantes | Conservantes | Inibidores de Corrosão | Resinas | Biossolventes | Antiespumantes | Emulsificantes | Outros",
